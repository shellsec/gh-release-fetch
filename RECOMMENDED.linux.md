...
> Auto-generated from [`apps/linux/`](apps/linux/) on **2026-06-27**. **539** entries.
...
| `continue` | Continue（Linux x64 .vsix，若 Release 提供） | `continuedev/continue` |
...
| `cursor` | Cursor（manifest 当前 linux 多为 null，勿盲目启用） | `-` |
