...
| `github_copilot_cli` | GitHub Copilot：IDE 插件或 gh copilot，无单一 Linux 安装包。 | `microsoft/vscode` |
| `goose_ai` | - | `block/goose` |
...
| `zen_desktop` | - | `ZenPrivacy/zen-desktop` |
| `zen_desktop_arm64` | - | `ZenPrivacy/zen-desktop` |
